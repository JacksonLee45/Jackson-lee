...
const getWorkshop = (slug: string) => {
  return {
    ...
    instructor: {
      name: "Jackson Lee",
      bio: "Full Stack Developer with over 5 years of experience building React applications. Jackson has worked with companies like TechCorp and StartupX, helping them implement scalable frontend architectures.",
